...
* Subclass :class:`terra_sdk.key.key.Key`
...
* Subclass :class:`terra_sdk.key.key.Key`
* Override :meth:`Key.create_signature()<terra_sdk.key.key.Key.create_signature>`
...
* Subclass :class:`terra_sdk.key.raw.RawKey`
* Customize key derivation in constructor
* Finish constructor by calling ``super()`` with derived private key
