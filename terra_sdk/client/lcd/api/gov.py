...
class AsyncGovAPI(BaseAsyncAPI):
    ...
    async def __search_submit_proposal(self, proposal_id: int):
        params = [
            ("events", "message.action='/cosmos.gov.v1beta1.MsgSubmitProposal'"),
    ...
    async def __search_deposits(
        ...
        events = [
            ("events", "message.action='/cosmos.gov.v1beta1.MsgDeposit'"),
    ...
    async def __search_votes(
        ...
        events = [
            ("events", "message.action='/cosmos.gov.v1beta1.MsgVote'"),
