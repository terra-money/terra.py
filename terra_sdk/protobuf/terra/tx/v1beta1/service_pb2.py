...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[gogoproto_dot_gogo__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,cosmos_dot_base_dot_v1beta1_dot_coin__pb2.DESCRIPTOR,cosmos_dot_tx_dot_v1beta1_dot_tx__pb2.DESCRIPTOR,])
...
_COMPUTETAXREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tx', full_name='terra.tx.v1beta1.ComputeTaxRequest.tx', index=0,
...
_COMPUTETAXRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tax_amount', full_name='terra.tx.v1beta1.ComputeTaxResponse.tax_amount', index=0,
...
_COMPUTETAXREQUEST.fields_by_name['tx'].message_type = cosmos_dot_tx_dot_v1beta1_dot_tx__pb2._TX
_COMPUTETAXRESPONSE.fields_by_name['tax_amount'].message_type = cosmos_dot_base_dot_v1beta1_dot_coin__pb2._COIN
...
ComputeTaxRequest = _reflection.GeneratedProtocolMessageType('ComputeTaxRequest', (_message.Message,), {
...
ComputeTaxResponse = _reflection.GeneratedProtocolMessageType('ComputeTaxResponse', (_message.Message,), {
