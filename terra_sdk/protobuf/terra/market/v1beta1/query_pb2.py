...
from terra.market.v1beta1 import market_pb2 as terra_dot_market_dot_v1beta1_dot_market__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[gogoproto_dot_gogo__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,terra_dot_market_dot_v1beta1_dot_market__pb2.DESCRIPTOR,cosmos_dot_base_dot_v1beta1_dot_coin__pb2.DESCRIPTOR,])
...
_QUERYSWAPREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='offer_coin', full_name='terra.market.v1beta1.QuerySwapRequest.offer_coin', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='ask_denom', full_name='terra.market.v1beta1.QuerySwapRequest.ask_denom', index=1,
...
_QUERYSWAPRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='return_coin', full_name='terra.market.v1beta1.QuerySwapResponse.return_coin', index=0,
...
_QUERYTERRAPOOLDELTARESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='terra_pool_delta', full_name='terra.market.v1beta1.QueryTerraPoolDeltaResponse.terra_pool_delta', index=0,
...
_QUERYPARAMSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='params', full_name='terra.market.v1beta1.QueryParamsResponse.params', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUERYSWAPRESPONSE.fields_by_name['return_coin'].message_type = cosmos_dot_base_dot_v1beta1_dot_coin__pb2._COIN
_QUERYPARAMSRESPONSE.fields_by_name['params'].message_type = terra_dot_market_dot_v1beta1_dot_market__pb2._PARAMS
...
DESCRIPTOR.message_types_by_name['QueryTerraPoolDeltaRequest'] = _QUERYTERRAPOOLDELTAREQUEST
DESCRIPTOR.message_types_by_name['QueryTerraPoolDeltaResponse'] = _QUERYTERRAPOOLDELTARESPONSE
...
QueryTerraPoolDeltaRequest = _reflection.GeneratedProtocolMessageType('QueryTerraPoolDeltaRequest', (_message.Message,), {
...
QueryTerraPoolDeltaResponse = _reflection.GeneratedProtocolMessageType('QueryTerraPoolDeltaResponse', (_message.Message,), {
