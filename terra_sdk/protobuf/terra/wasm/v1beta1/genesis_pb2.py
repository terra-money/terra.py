...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[gogoproto_dot_gogo__pb2.DESCRIPTOR,terra_dot_wasm_dot_v1beta1_dot_wasm__pb2.DESCRIPTOR,cosmos_dot_base_dot_v1beta1_dot_coin__pb2.DESCRIPTOR,])
...
_GENESISSTATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='params', full_name='terra.wasm.v1beta1.GenesisState.params', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='last_code_id', full_name='terra.wasm.v1beta1.GenesisState.last_code_id', index=1,
      number=2, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342\336\037\nLastCodeID', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='last_instance_id', full_name='terra.wasm.v1beta1.GenesisState.last_instance_id', index=2,
      number=3, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342\336\037\016LastInstanceID', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='codes', full_name='terra.wasm.v1beta1.GenesisState.codes', index=3,
      ...
      serialized_options=b'\310\336\037\000', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='contracts', full_name='terra.wasm.v1beta1.GenesisState.contracts', index=4,
...
_MODEL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='terra.wasm.v1beta1.Model.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='terra.wasm.v1beta1.Model.value', index=1,
...
_CODE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='code_info', full_name='terra.wasm.v1beta1.Code.code_info', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\310\336\037\000', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='code_bytes', full_name='terra.wasm.v1beta1.Code.code_bytes', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONTRACT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='contract_info', full_name='terra.wasm.v1beta1.Contract.contract_info', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\310\336\037\000', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='contract_store', full_name='terra.wasm.v1beta1.Contract.contract_store', index=1,
...
_GENESISSTATE.fields_by_name['params'].message_type = terra_dot_wasm_dot_v1beta1_dot_wasm__pb2._PARAMS
_GENESISSTATE.fields_by_name['codes'].message_type = _CODE
_GENESISSTATE.fields_by_name['contracts'].message_type = _CONTRACT
_CODE.fields_by_name['code_info'].message_type = terra_dot_wasm_dot_v1beta1_dot_wasm__pb2._CODEINFO
_CONTRACT.fields_by_name['contract_info'].message_type = terra_dot_wasm_dot_v1beta1_dot_wasm__pb2._CONTRACTINFO
