...
_PARAMS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='max_contract_size', full_name='terra.wasm.v1beta1.Params.max_contract_size', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\362\336\037\030yaml:\"max_contract_size\"', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_contract_gas', full_name='terra.wasm.v1beta1.Params.max_contract_gas', index=1,
      number=2, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\362\336\037\027yaml:\"max_contract_gas\"', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_contract_msg_size', full_name='terra.wasm.v1beta1.Params.max_contract_msg_size', index=2,
      number=3, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\362\336\037\034yaml:\"max_contract_msg_size\"', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_CODEINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='code_id', full_name='terra.wasm.v1beta1.CodeInfo.code_id', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='code_hash', full_name='terra.wasm.v1beta1.CodeInfo.code_hash', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='creator', full_name='terra.wasm.v1beta1.CodeInfo.creator', index=2,
...
_CONTRACTINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='address', full_name='terra.wasm.v1beta1.ContractInfo.address', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='creator', full_name='terra.wasm.v1beta1.ContractInfo.creator', index=1,
      ...
      serialized_options=b'\362\336\037\016yaml:\"creator\"', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='admin', full_name='terra.wasm.v1beta1.ContractInfo.admin', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='code_id', full_name='terra.wasm.v1beta1.ContractInfo.code_id', index=3,
      ...
      serialized_options=b'\362\336\037\016yaml:\"code_id\"\342\336\037\006CodeID', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='init_msg', full_name='terra.wasm.v1beta1.ContractInfo.init_msg', index=4,
