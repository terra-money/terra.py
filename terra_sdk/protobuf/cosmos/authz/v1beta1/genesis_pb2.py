...
_GENESISSTATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="authorization",
            full_name="cosmos.authz.v1beta1.GenesisState.authorization",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_GRANTAUTHORIZATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="granter",
            full_name="cosmos.authz.v1beta1.GrantAuthorization.granter",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="grantee",
            full_name="cosmos.authz.v1beta1.GrantAuthorization.grantee",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="authorization",
            full_name="cosmos.authz.v1beta1.GrantAuthorization.authorization",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="expiration",
            full_name="cosmos.authz.v1beta1.GrantAuthorization.expiration",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
