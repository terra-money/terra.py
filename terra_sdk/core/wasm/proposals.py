...
from terra_proto.cosmwasm.wasm.v1 import ExecuteContractProposal as ExecuteContractProposal_pb
from terra_proto.cosmwasm.wasm.v1 import InstantiateContractProposal as InstantiateContractProposal_pb
from terra_proto.cosmwasm.wasm.v1 import MigrateContractProposal as MigrateContractProposal_pb
...
from terra_proto.cosmwasm.wasm.v1 import UpdateInstantiateConfigProposal as UpdateInstantiateConfigProposal_pb
...
class UpdateInstantiateConfigProposal(JSONSerializable):
    ...
    def to_amino(self) ->dict:
        return{
            ...
            "value" :{
                "title" : self.title,
                "description" : self.description,
                "access_config_updates" : [access_config_update.to_amino() for access_config_update in self.access_config_updates]
            }
        }
    def to_data(self) -> dict :
        return {
            ...
            "title" : self.title,
            "description" : self.description,
            "access_config_updates" : [access_config_update.to_data() for access_config_update in self.access_config_updates]
        }
    def to_proto(self) -> UpdateInstantiateConfigProposal:
        return UpdateInstantiateConfigProposal_pb(
            title=self.title,
            description=self.description,
            access_config_updates=[access_config_update.to_proto() for access_config_update in self.access_config_updates],
        )
    ...
    def from_data(cls, data):
        return cls(
            title=data["title"],
            description=data["description"],
            access_config_updates=[AccessConfigUpdate.from_data(access_config_update) for access_config_update in data["access_config_updates"]]
        )
    ...
    def from_proto(cls, proto:UpdateInstantiateConfigProposal_pb):
        return cls(
            title = proto.title,
            description=proto.description,
            access_config_updates=[AccessConfigUpdate.from_proto(access_config_update) for access_config_update in proto.access_config_updates]
        )