...
def test_delegations():
    ...
    result = terra.staking.delegations(validator=None, delegator='terra1x46rqay4d3cssq8gxxvqz8xt6nwlz4td20k38v',
                                       params=pagOpt)
    assert(result is not None)
    result = terra.staking.delegations(validator='terravaloper1rdkyl03zd4d2g8hlchf0cmpwty2et4vfdjlaef',
                                       delegator='terra1x46rqay4d3cssq8gxxvqz8xt6nwlz4td20k38v')
    assert(result is not None)
    result = terra.staking.delegation(validator='terravaloper1rdkyl03zd4d2g8hlchf0cmpwty2et4vfdjlaef',
                                      delegator='terra1x46rqay4d3cssq8gxxvqz8xt6nwlz4td20k38v')
    assert(result is not None)
...
def test_unbonding():
    ...
    result = terra.staking.unbonding_delegations(validator='terravaloper1vk20anceu6h9s00d27pjlvslz3avetkvnwmr35',
                                                 delegator=None)
    assert(result is not None)
    result = terra.staking.unbonding_delegations(validator=None,
                                                 delegator='terra17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp',
                                                 params=pagOpt)
    assert(result is not None)
...
def test_redelagations():
    ...
    result = terra.staking.redelegations("terra17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp", params=_pagOpt)
    assert(result is not None)
