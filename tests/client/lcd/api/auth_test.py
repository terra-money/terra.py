...
def test_account_info():
    ...
    assert result.base_vesting_account.base_account.address == "terra186wj7gy9q5syg0kls4cctgn23d9xh3d6h3dqq9"
    ...
    assert result.base_vesting_account.base_account.address == "terra1auswfkggetjrhe8jxkzngfd26hugz55d64p0z6"
